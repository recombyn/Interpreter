"""Load src/cni/data/world/system.tm — table-1 algorithm vocab/closed sets (not user dict)."""
...
def clear_system_cache() -> None:
    """Clear only load_system; prefer clear_tm_caches."""
...
def clear_tm_caches() -> None:
    ...
    load_system.cache_clear()
    from cni.text.d66 import clear_d66_cache

    clear_d66_cache()
    # Lazy imports: avoid circular deps with preprocess/repair at module load
    from cni.preprocess import load_user_dict
    from cni.repair import clear_pin_map_cache
    from cni.render.forms import clear_forms_cache

...
Usage: python -m para.tools.compile_limits [--write]
"""
...
from para.judge import load_judge_rules, norm_duration_unit, parse_cn_int
...
def scan_user_docs(user_dir: Path | None = None) -> list[Extracted]:
    from para.knowledge.text_doc import list_user_texts

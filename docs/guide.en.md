...
| Path                                                            | Content                                          |
| ---------------------------------------------------------------- | ------------------------------------------------- |
| `knowledge/user/user_dict.tm`                                   | Table 2 lexicon (`map`); also merges `*.maps.tm` |
| `knowledge/user/*.text` etc.                                    | Long-doc source; may live under domain folders   |
...
| Item               | Behavior                                                                                                       |
| ------------------- | --------------------------------------------------------------------------------------------------------------- |
| Ambiguity          | `config.tm` `ambig_mode first\                                                                                 |
